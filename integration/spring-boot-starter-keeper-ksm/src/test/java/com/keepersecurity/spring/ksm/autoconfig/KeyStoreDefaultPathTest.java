...
@SpringBootTest(
    classes = {KeeperKsmAutoConfiguration.class, KeyStoreDefaultPathTest.MockOptionsConfig.class},
    properties = {"keeper.ksm.provider-type=default", "keeper.ksm.secret-user=ksm-config",
        "keeper.ksm.secret-password=changeme", "spring.main.allow-bean-definition-overriding=true"})
class KeyStoreDefaultPathTest {

  private static final MockedStatic<KsmKeystoreDefaults> DEFAULTS =
      Mockito.mockStatic(KsmKeystoreDefaults.class);
  static {
